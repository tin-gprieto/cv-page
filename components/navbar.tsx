...
export function Navbar({ lang, onToggleLang }: NavbarProps) {
  ...
  const handleDownload = () => {
    ...
    link.href = lang === "es" ? "/pdf/Martín_González_Prieto_CV.pdf" : "/pdf/Martín_González_Prieto_CV_EN.pdf"
    link.download = lang === "es" ? "Martín_González_Prieto_CV.pdf" : "Martín_González_Prieto_CV_EN.pdf"
